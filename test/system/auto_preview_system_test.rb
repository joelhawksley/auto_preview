...
class AutoPreviewSystemTest < SystemTestCase
  # Helper to assert text within the preview iframe's srcdoc attribute
  def assert_preview_text(text)
    iframe = find("iframe#previewFrame")
    srcdoc = iframe["srcdoc"]
    assert srcdoc.include?(text), "Expected iframe srcdoc to include '#{text}' but it did not.\nSrcdoc content: #{srcdoc[0..500]}..."
  end

  # Helper to check for text within the preview iframe's srcdoc
  ...
  test "multi variable template auto-fills and renders" do
    ...
    assert_preview_text "First:"
    assert_preview_text "Second:"

    # Sidebar should be present with the auto-filled variables
    assert_selector ".auto-preview-sidebar"
  ...
  test "float type variable via url params" do
    ...
    assert_preview_text "Hello, 3.14!"
  end
  ...
  test "boolean type variable via url params" do
    ...
    assert_preview_text "Hello, true!"
  end
  ...
  test "factory type variable auto-fills and renders user from factory" do
    ...
    assert_preview_text "john@example.com"
  ...
  test "factory type variable with trait via url params" do
    ...
    assert_preview_text "Admin User"
    assert_preview_text "admin@example.com"
  ...
  test "predicate helper auto-fills and renders" do
    ...
    assert(has_preview_text?("Premium User") || has_preview_text?("Basic User"))
  ...
  test "predicate helper true value shows premium content" do
    ...
    assert_preview_text "Advanced analytics"
    assert_preview_text "Your name: Alice"
  end
  ...
  test "predicate helper false value shows basic content" do
    ...
    assert_preview_text "Upgrade to premium"
    assert_preview_text "Your name: Bob"
  end
  ...
  test "sidebar is present after auto-fill rendering" do
    ...
    # Sidebar elements should be present
    assert_selector ".auto-preview-sidebar"
    assert_selector "#autoPreviewForm"
  end

  test "sidebar shows existing variables" do
    ...
    assert_preview_text "First: hello"
    assert_preview_text "Second: world"

    # Sidebar elements should be in the page
    assert_selector ".auto-preview-sidebar"
    # The sidebar should contain the form with variable names
    assert page.html.include?("first_var")
    assert page.html.include?("second_var")
